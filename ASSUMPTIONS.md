...
| A013 | The frozen `N=30`, `K=3`, `T=10^7` G1 runner stays below 1.5 GB RSS and eight hours on the M4 Air. | untested | Distinct-seed 100,000-row timing/RSS shard after implementation is committed. | The G1 compute design fails and must be redesigned and logged before the frozen draw. |
