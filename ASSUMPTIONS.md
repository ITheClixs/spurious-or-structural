...
| A012 | The G1 primitive-only formulas condition on `f`, `u`, `v`, and proxy noise having zero contemporaneous cross-covariances. | untested | Enforce independent streams in G1 and design empirical covariance diagnostics before structural estimation. | Additional covariance terms enter both probability limits; the G1 formulas remain conditional rather than empirically complete. |
